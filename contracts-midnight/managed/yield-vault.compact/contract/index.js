...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    if (typeof(witnesses_0.depositCommitmentData) !== 'function') {
      throw new __compactRuntime.CompactError('first (witnesses) argument to Contract constructor does not contain a function-valued field named depositCommitmentData');
    }
      ...
      deposit: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('deposit',
                                     ...
                                     'yield-vault.compact line 27 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
      ...
      proveOwnership: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('proveOwnership',
                                     'argument 1 (as invoked from Typescript)',
                                     'yield-vault.compact line 40 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        const context = { ...contextOrig_0, gasCost: __compactRuntime.emptyRunningCost() };
  ...
  initialState(...args_0) {
    ...
    if (!(adminSk_0.buffer instanceof ArrayBuffer && adminSk_0.BYTES_PER_ELEMENT === 1 && adminSk_0.length === 32)) {
      __compactRuntime.typeError('Contract state constructor',
                                 ...
                                 'yield-vault.compact line 15 char 1',
                                 'Bytes<32>',
                                 adminSk_0)
    }
    ...
    __compactRuntime.queryLedgerState(context,
                                      ...
                                      [
                                       ...
                                       { ins: { cached: false, n: 1 } }]);
    const tmp_0 = this._persistentHash_0([new Uint8Array([109, 105, 100, 110, 105, 103, 104, 116, 58, 51, 114, 105, 107, 101, 58, 118, 97, 117, 108, 116, 58, 97, 100, 109, 105, 110, 0, 0, 0, 0, 0, 0]),
                                          adminSk_0]);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
  ...
  _depositCommitmentData_0(context, partialProofData) {
    const witnessContext_0 = __compactRuntime.createWitnessContext(ledger(context.currentQueryContext.state), context.currentPrivateState, context.currentQueryContext.address);
    const [nextPrivateState_0, result_0] = this.witnesses.depositCommitmentData(witnessContext_0);
    context.currentPrivateState = nextPrivateState_0;
    if (!(result_0.buffer instanceof ArrayBuffer && result_0.BYTES_PER_ELEMENT === 1 && result_0.length === 32)) {
      __compactRuntime.typeError('depositCommitmentData',
                                 'return value',
                                 'yield-vault.compact line 25 char 1',
                                 'Bytes<32>',
                                 result_0)
    }
  ...
  _deposit_0(context, partialProofData) {
    const raw_0 = this._depositCommitmentData_0(context, partialProofData);
    const commitment_0 = this._persistentHash_0([new Uint8Array([109, 105, 100, 110, 105, 103, 104, 116, 58, 51, 114, 105, 107, 101, 58, 118, 97, 117, 108, 116, 58, 100, 101, 112, 111, 115, 105, 116, 0, 0, 0, 0]),
                                                 raw_0]);
      ...
      member(...args_0) {
        ...
        if (!(elem_0.buffer instanceof ArrayBuffer && elem_0.BYTES_PER_ELEMENT === 1 && elem_0.length === 32)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'yield-vault.compact line 12 char 1',
                                     'Bytes<32>',
                                     elem_0)
        }
        return _descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
...
const _dummyContract = new Contract({
  depositCommitmentData: (...args) => undefined
});
